...
寬度計算：全形字（中日韓文字、全形標點）算 1.8，Tab 算 2，其他算 1。
實測 1280×720 的投影片，程式碼區塊一行約可容納 66～70 個半形字元（class: code-sm 約 80 個）；最終以 check-overflow.mjs 在瀏覽器中實測的「換行」結果為準。"""
